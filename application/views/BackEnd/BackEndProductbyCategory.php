...
<div id="page-wrapper">
	<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><?php if(isset($header)) echo "Product - ".$header; else echo "Product" ?>
            	<button style="float:right" class="btn btn-primary" onclick="document.location='<?php echo base_url(); ?>BackEnd/Products/addProduct/<?php echo $categoryID; ?>'">
                    <span class="fa fa-plus"></span> Add Product to This Category
                </button>
            </h1>
        </div>
    </div>
