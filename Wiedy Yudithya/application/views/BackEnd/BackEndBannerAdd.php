...
<div class="row" id="input_customer_form">
            <div class="col-md-offset-2 col-md-8">
                <form method="post"  method="POST" enctype ="multipart/form-data" action="<?php echo base_url() ?>BackEnd/Banner/addBanner">
                    <h2>Add Banner</h2>                  
                    <hr />
                            ...
                            <option value=""> --Select Category-- </option>
                                 <?php 
                                     for($i=0;$i<count($category);$i++) { 
                                        ?>
                               <option value="<?php echo $category[$i]->categoryID;?>">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <option value=""> --Select Product-- </option>
                               ...
                               <option value="<?php echo $product[$i]->ProductID;?>">
