...
<div class="span12">
	...
	<div class="row">	  
            ...
            <a href="themes/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="<?php echo base_url();?>assets/themes/images/products/a.png" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
					...
					<li class="span3">
					  <div class="thumbnail">
						...
						<div class="caption">
						  ...
						  <h4 style="text-align:center"><a class="btn" href="<?php echo base_url();?>assets/product_details.html"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">&euro;222.00</a></h4>
						</div>
					  </div>
					</li>
					<li class="span3">
